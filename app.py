...
def store_temperature_data_job():
    ...
    o_data = fetch_from_serial('o\n')
    i_data = fetch_from_serial('i\n')

    if o_data and i_data and 'value' in o_data and 'value' in i_data:
        record = {
            'timestamp': datetime.now().isoformat(),
            'indoor_temp_C': i_data['value'],
            'outdoor_temp_C': o_data['value']
        }
